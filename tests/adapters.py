...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.models import attention
...
def run_get_batch(
    ...
    """
    from cs336_basics.train_utils import dataloader
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.models import cross_entropy_loss
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.models import gradient_clip

    gradient_clip(parameters=parameters, max_l2_norm=max_l2_norm)
...
def get_adamw_cls() -> Any:
    ...
    """
    from cs336_basics.models import AdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.models import lr_cosine_schedule
